  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      <header className="mb-10">
        <h1 className="text-2xl font-bold text-ink-900">About The Deal Board</h1>
      ...
      <section className="space-y-6 text-sm text-ink-700 leading-relaxed mb-10">
        <p>
          The Deal Board tracks emerging buyers and new forms of entertainment financing. We focus on
        ...
        <p>
          The Deal Board is for working entertainment professionals — writers, producers, directors,
